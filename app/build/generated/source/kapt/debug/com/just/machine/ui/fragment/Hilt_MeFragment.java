...
public abstract class Hilt_MeFragment<VB extends ViewDataBinding> extends CommonBaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MeFragment_GeneratedInjector) this.generatedComponent()).injectMeFragment(UnsafeCasts.<MeFragment>unsafeCast(this));
    }
  }
