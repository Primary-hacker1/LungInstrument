...
public abstract class Hilt_NewFragment<VB extends ViewDataBinding> extends CommonBaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewFragment_GeneratedInjector) this.generatedComponent()).injectNewFragment(UnsafeCasts.<NewFragment>unsafeCast(this));
    }
  }
