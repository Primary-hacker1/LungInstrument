...
import com.just.news.databinding.ActivityPatientBindingImpl;
...
import com.just.news.databinding.ItemLayoutPatientBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYPATIENT = 4;

  private static final int LAYOUT_ACTIVITYSIXMIN = 5;

  private static final int LAYOUT_ACTIVITYSUCCEEDPRISON = 6;

  private static final int LAYOUT_ACTIVITYWEB = 7;

  private static final int LAYOUT_ACTIVITYWELCOME = 8;

  private static final int LAYOUT_FRAGMELAYOUTSUCCEED = 9;

  private static final int LAYOUT_FRAGMENTLOGIN = 10;

  private static final int LAYOUT_FRAGMENTMAIN = 11;

  private static final int LAYOUT_FRAGMENTME = 12;

  private static final int LAYOUT_FRAGMENTNEW = 13;

  private static final int LAYOUT_FRAGMENTSETTING = 14;

  private static final int LAYOUT_ITEMLAYOUTPATIENT = 15;

  private static final int LAYOUT_ITEMNEW = 16;

  private static final int LAYOUT_VIEWTOOLBAR = 17;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.just.news.R.layout.activity_patient, LAYOUT_ACTIVITYPATIENT);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.just.news.R.layout.item_layout_patient, LAYOUT_ITEMLAYOUTPATIENT);
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_ITEMLAYOUTPATIENT: {
          if ("layout/item_layout_patient_0".equals(tag)) {
            return new ItemLayoutPatientBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for item_layout_patient is invalid. Received: " + tag);
        }
        case  LAYOUT_ITEMNEW: {
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/activity_patient_0", com.just.news.R.layout.activity_patient);
      ...
      sKeys.put("layout/item_layout_patient_0", com.just.news.R.layout.item_layout_patient);
