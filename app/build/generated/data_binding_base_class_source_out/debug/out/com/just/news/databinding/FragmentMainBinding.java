...
public abstract class FragmentMainBinding extends ViewDataBinding {
  @NonNull
  public final AppCompatButton btnEcg;

  @NonNull
  public final AppCompatButton btnPatientInformation;
  ...
  protected FragmentMainBinding(Object _bindingComponent, View _root, int _localFieldCount,
      AppCompatButton btnEcg, AppCompatButton btnPatientInformation,
      AppCompatButton walkTestButton) {
    super(_bindingComponent, _root, _localFieldCount);
    this.btnEcg = btnEcg;
    this.btnPatientInformation = btnPatientInformation;
