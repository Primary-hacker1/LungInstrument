...
import com.justsafe.libview.core.BatteryViewOrientation;
import com.justsafe.libview.core.OnBatteryPowerListener;
...
//                Log.i("BatteryManager4", currentPower + "");
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        ...
        // 电池实心部分
        lowColor = ta.getColor(R.styleable.BatteryView_bv_power_color_low, mContext.getResources().getColor(R.color.red));
        lowValue = ta.getInt(R.styleable.BatteryView_bv_power_value_low, 10);
        mediumColor = ta.getColor(R.styleable.BatteryView_bv_power_color_medium, mContext.getResources().getColor(R.color.white));
        mediumValue = ta.getInt(R.styleable.BatteryView_bv_power_value_medium, 20);
        highColor = ta.getColor(R.styleable.BatteryView_bv_power_color_high, mContext.getResources().getColor(R.color.white));

        headerColor = ta.getColor(R.styleable.BatteryView_bv_header_color, Color.WHITE);

        noChargingHighColor = ta.getColor(R.styleable.BatteryView_bv_no_charging_color_high, mContext.getResources().getColor(R.color.white));
